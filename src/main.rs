...
fn main() -> Result<(), Error> {
    ...
    if file_exists("day_1") && (run_all || &arguments[1] == "day_1") {
        day_1::solve(&read_file("day_1")?);
    }

    if file_exists("day_2") && (run_all || &arguments[1] == "day_2") {
        day_2::solve(&read_file("day_2")?);
    }

    if file_exists("day_3") && (run_all || &arguments[1] == "day_3") {
        day_3::solve(&read_file("day_3")?);
    }

    if file_exists("day_4") && (run_all || &arguments[1] == "day_4") {
        day_4::solve(&read_file("day_4")?);
    }

    if file_exists("day_5") && (run_all || &arguments[1] == "day_5") {
        day_5::solve(&read_file("day_5")?);
    }

    if file_exists("day_6") && (run_all || &arguments[1] == "day_6") {
